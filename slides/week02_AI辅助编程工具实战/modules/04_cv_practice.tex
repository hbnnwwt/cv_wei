...
\begin{frame}{实战 1：引导 AI 写出滤波代码}
	...
	\begin{alertblock}{AI辅助提示}
		你可以使用Cursor、ChatGPT、Claude等AI工具来辅助完成本节实战任务。
		...
		\textbf{Prompt示例：}
		\texttt{请用Python和OpenCV实现图像去噪，分别使用高斯滤波和中值滤波，对比效果。}
	\end{alertblock}
...
\begin{frame}{实战 2：引导 AI 解决透视变换}
	...
	\begin{columns}
		...
		\begin{exampleblock}{概念 Prompt}
			\small
			请解释 OpenCV 中的透视变换原理：
			\begin{enumerate}
				\item 什么是透视变换？
				\item getPerspectiveTransform 做了什么？
				\item warpPerspective 做了什么？
				\item 用简单的比喻解释
			\end{enumerate}
		\end{exampleblock}
		...
		\begin{itemize}
			...
			\item \textbf{getPerspectiveTransform} = 计算"怎么拉"
...
\begin{frame}{实战 3：自动识别答题卡边缘（迭代优化）}
	...
	\begin{columns}
		...
		\textbf{效果：}[star][star][star-empty][star-empty][star-empty]
		...
		\textbf{效果：}[star][star][star][star][star-empty]
		...
		\textbf{效果：}[star][star][star][star][star]
	\end{columns}
\end{frame}

% -----------------------------------------------------------------------------
% 5. 实战任务：人脸检测（从第2周原有内容保留）
% -----------------------------------------------------------------------------
