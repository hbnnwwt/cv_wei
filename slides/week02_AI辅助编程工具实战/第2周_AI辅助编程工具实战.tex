...
\begin{frame}{下节预告}
    ...
    \textbf{知识衔接：}
    \begin{itemize}
        \item \textbf{直方图与统计}（第1周） $\to$ 下周将学习基于直方图的阈值算法（Otsu）
        \item \textbf{定位锚点}（第1周） $\to$ 下周将学习透视矫正的角点检测
        \item \textbf{中文路径处理}（第1周） $\to$ 下周将学习批量图像预处理流程
        \item \textbf{JPEG压缩}（第1周） $\to$ 下周将学习去噪技术弥补压缩损失
    \end{itemize}
