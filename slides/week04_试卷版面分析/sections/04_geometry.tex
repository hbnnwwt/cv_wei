...
\codesrc{code/geometry\_features.py :: compute\_contour\_features()}
\end{frame}
...
\codesrc{code/geometry\_features.py :: polygon\_approximation()}
\end{frame}
...
\codesrc{code/geometry\_features.py :: compute\_convex\_hull()}
\end{frame}
...
\codesrc{code/geometry\_features.py :: find\_paper\_contour()}
\end{frame}
...
\codesrc{code/geometry\_features.py :: match\_shapes()}
\end{frame}
