...
# GUI文件列表
GUI_DEMOS = [
    ("gui_01_opencv_basics.py", "OpenCV 基础演示", "图像读取、滤镜、增强等基础操作"),
    ("gui_02_grading_system.py", "阅卷系统预处理", "边缘检测、形态学操作、轮廓定位 - 可调参数"),
    ("gui_03_bubble_detection.py", "气泡检测演示", "智能阅卷系统 - 气泡检测与填涂识别"),
    ("gui_04_quality_detection.py", "图像质量检测", "亮度、对比度、清晰度、噪声检测"),
    ("gui_05_batch_processing.py", "批量处理演示", "批量处理试卷、统计答案分布 - 可调参数"),
    ("gui_06_quick_challenge.py", "闪电编程挑战", "NumPy数组操作实战 - 可调整ROI区域"),
]
...
class LauncherGUI(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.title("Week 01 教学演示 - GUI启动器")
